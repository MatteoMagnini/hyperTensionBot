...
namespace HyperTensionBot.Server.LLM.Strategy {
    ...
    public class LLMService {
        ...
        public async Task<string> HandleAskAsync(TypeConversation t, List<ChatMessage>? comunicationChat = null, List<ChatMessage>? context = null) {
            return await _llm.AskLLM(t, comunicationChat, context);
        }
